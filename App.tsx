      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4 text-center">
        ...
        <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl max-w-lg w-full border border-gray-700">
            <div className="mb-6">
                ...
                <h3 className="text-xl font-semibold mb-2">API Key Selection Needed</h3>
                <p className="text-gray-300 mb-4">
                    To use high-quality models (like Veo for video and Imagen for 4K photos), you must select a <strong>Google Cloud Project with Billing Enabled</strong>.
                </p>
                <p className="text-sm text-gray-400 bg-black/30 p-3 rounded">
                    If you see a "Quota Exceeded" or "Limit 0" error, it means the selected project is on a Free Tier or has no quota. Please switch to a paid project.
                </p>
            </div>
